...
[![](assets/appfinder.png \
  "App Finder (full width centered)")](assets/appfinder.png)

And there is a collapsed version assigned to `Alt + F2`.

[![](assets/appfinder-collapsed.png \
  "Collapsed App Finder(full width centered)")](assets/appfinder-collapsed.png)
